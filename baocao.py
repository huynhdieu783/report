...
class BaoCao:
    ...
    def __init__(self, user: User, muc_do_van_dong="trung_binh",
                 file_bua_an="bua_an.json"):
        self.user = user
...
if __name__ == "__main__":
    user = User("An", 22, "Nam", 1.75, 70, 65)
    bc = BaoCao(user, muc_do_van_dong="trung_binh", file_bua_an="bua_an.json")

    bc.bao_cao_tuan()                    # Tuần hiện tại
    bc.bao_cao_thang()                   # Tháng hiện tại
    bc.bao_cao_thang(thang=2, nam=2026)  # Tháng cụ thể